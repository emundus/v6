ALTER TABLE `#__miniorange_saml_config` ADD COLUMN `first_name` VARCHAR (128) NOT NULL;
ALTER TABLE `#__miniorange_saml_config` ADD COLUMN `last_name` VARCHAR (128) NOT NULL;
ALTER TABLE `#__miniorange_saml_customer_details` MODIFY COLUMN `licensePlan` VARCHAR (56) NOT NULL;
