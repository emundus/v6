CREATE TABLE `jos_emundus_cifre_links` (
  ...
  `time_date_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `time_date_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
