...
INSERT INTO jos_content (id,asset_id, title, alias, introtext, `fulltext`, state, catid, created, created_by, created_by_alias, modified, modified_by, checked_out, checked_out_time, publish_up, publish_down, images, urls, attribs, version, ordering, metakey, metadesc, access, hits, metadata, featured, language, xreference, note) VALUES (1000, 303, 'Bienvenue dans votre espace de gestion', 'bienvenue-dans-votre-espace-de-gestion', '<p style="text-align: center;"><span style="font-size: 14pt; color: #de6339;">  <img src="/images/emundus/saas_tutorial/fusee.png" alt="" width="290" height="193" /></span></p>
