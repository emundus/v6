...
INSERT INTO jos_menu (menutype, title, alias, note, path, link, type, published, parent_id, level, component_id, checked_out, checked_out_time, browserNav, access, img, template_style_id, params, lft, rgt, home, language, client_id) VALUES ('main', 'COM_EXTERNALLOGIN_MENU', 'com-externallogin-menu', '', 'com-externallogin-menu', 'index.php?option=com_externallogin', 'component', 1, 1, 1, @extension_parent_id, 0, '2021-10-20 16:42:39', 0, 1, '../media/com_externallogin/images/administrator/icon-16-externallogin.png', 0, '{}', 0, 0, 0, '', 1);
SET @menu_parent_id := LAST_INSERT_ID();

INSERT INTO jos_menu (menutype, title, alias, note, path, link, type, published, parent_id, level, component_id, checked_out, checked_out_time, browserNav, access, img, template_style_id, params, lft, rgt, home, language, client_id) VALUES ('main', 'COM_EXTERNALLOGIN_MENU_USERS', 'com-externallogin-menu-users', '', 'com-externallogin-menu/com-externallogin-menu-users', 'index.php?option=com_externallogin&view=users', 'component', 1, @menu_parent_id, 2, @extension_parent_id, 0, '2021-10-20 16:42:39', 0, 1, '../media/com_externallogin/images/administrator/icon-16-users.png', 0, '{}', 0, 0, 0, '', 1);
INSERT INTO jos_menu (menutype, title, alias, note, path, link, type, published, parent_id, level, component_id, checked_out, checked_out_time, browserNav, access, img, template_style_id, params, lft, rgt, home, language, client_id) VALUES ('main', 'COM_EXTERNALLOGIN_MENU_LOGS', 'com-externallogin-menu-logs', '', 'com-externallogin-menu/com-externallogin-menu-logs', 'index.php?option=com_externallogin&view=logs', 'component', 1, @menu_parent_id, 2, @extension_parent_id, 0, '2021-10-20 16:42:39', 0, 1, '../media/com_externallogin/images/administrator/icon-16-logs.png', 0, '{}', 0, 0, 0, '', 1);
INSERT INTO jos_menu (menutype, title, alias, note, path, link, type, published, parent_id, level, component_id, checked_out, checked_out_time, browserNav, access, img, template_style_id, params, lft, rgt, home, language, client_id) VALUES ('main', 'COM_EXTERNALLOGIN_MENU_ABOUT', 'com-externallogin-menu-about', '', 'com-externallogin-menu/com-externallogin-menu-about', 'index.php?option=com_externallogin&view=about', 'component', 1, @menu_parent_id, 2, @extension_parent_id, 0, '2021-10-20 16:42:39', 0, 1, '../media/com_externallogin/images/administrator/icon-16-about.png', 0, '{}', 0, 0, 0, '', 1);

-- INSERT INTO jos_modules
INSERT INTO jos_modules (asset_id, title, note, content, ordering, position, checked_out, checked_out_time, publish_up, publish_down, published, module, access, showtitle, params, client_id, language) VALUES (@asset_id, 'External Login', '', '', 0, '', 0, null, null, null, 0, 'mod_externallogin_site', 1, 1, '', 0, '*');
INSERT INTO jos_modules (asset_id, title, note, content, ordering, position, checked_out, checked_out_time, publish_up, publish_down, published, module, access, showtitle, params, client_id, language) VALUES (@asset_id, 'External Login', '', '', 0, '', 0, null, null, null, 0, 'mod_externallogin_admin', 1, 1, '', 1, '*');