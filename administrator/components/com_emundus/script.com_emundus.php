					...
					if (!empty($group_id)) {
						...
						if ($inserted) {
							...
							EmundusHelperUpdate::addJsAction([
								...
								'action' => 'load',
								'code' => 'const value=this.get(&#039;value&#039;);const fab=this.form.elements;let{jos_emundus_campaign_workflow_repeat_documents___id_0}=fab;if(value!= &#039;0&#039;){showFabrikGroupByElt(jos_emundus_campaign_workflow_repeat_documents___id_0)}else{hideFabrikGroupByElt(jos_emundus_campaign_workflow_repeat_documents___id_0)}'
							]);
							EmundusHelperUpdate::addJsAction([
								'element_id' => $specific_documents_id,
								'action' => 'change',
