    ...
    public function update($parent)
    {
        ...
        if ($this->manifest_cache) {
            ...
            if (version_compare($cache_version, '1.33.0', '<') || $firstrun) {
                ...
                $this->h_update->updateYamlVariable('offcanvas','16rem',JPATH_ROOT . '/templates/g5_helium/custom/config/default/styles.yaml','width');
                $this->h_update->updateYamlVariable('breakpoints','48rem',JPATH_ROOT . '/templates/g5_helium/custom/config/default/styles.yaml','mobile-menu-breakpoint');
                $this->h_update->updateYamlVariable('menu','11rem',JPATH_ROOT . '/templates/g5_helium/custom/config/default/styles.yaml','col-width');
            }
        }
    }
