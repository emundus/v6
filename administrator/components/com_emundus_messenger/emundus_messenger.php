...
// Access check.
if (!JFactory::getUser()->authorise('core.manage', 'com_emundus_messenger'))
{
...
foreach ($controllers as $controller) {
    $link = JRoute::_("index.php?option=com_emundus_messenger&controller=".$controller);
    $selected = ($controller == JRequest::getWord('controller'));
    JSubMenuHelper::addEntry(JText::_( 'MENU_' . strtoupper($controller) ), "index.php?option=com_emundus_messenger&controller=".$controller, ($controller == JRequest::getWord('controller')));
}
...
$classname	= 'Emundus_messengerController'.$controller;
