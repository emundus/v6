...
<form name="adminForm" id="adminForm" action="index.php" method="post" class="akeeba-form--horizontal">
	...
	<div class="akeeba-panel--primary">
		<header class="akeeba-block-header">
			<h3>@lang('COM_ADMINTOOLS_LBL_SEOANDLINKTOOLS_OPTGROUP_TOOLS')</h3>
		</header>

		<div class="akeeba-form-group">
			<label for="httpsizer">@lang('COM_ADMINTOOLS_LBL_SEOANDLINKTOOLS_OPT_HTTPSIZER')</label>

			@jhtml('FEFHelp.select.booleanswitch', 'httpsizer', $this->salconfig['httpsizer'])
		</div>
	</div>
