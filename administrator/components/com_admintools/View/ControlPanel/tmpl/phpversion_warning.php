...
if (!function_exists('akeeba_common_phpversion_warning'))
{
	 ...
	 * @throws  Exception
	 */
	function akeeba_common_phpversion_warning($config = [])
	{
		/**
		...
		elseif ($isEol):
			...
			<div class="<?php echo $class_priority_medium ?>">
				...
				<p>
					Your site is currently using PHP <?php echo $longVersion ?>. This version of PHP has recently become
					<a
							href="https://php.net/eol.php" target="_blank">End-of-Life
						since <?php echo $eolDateFormatted ?></a>. It has
				...
				<p>
					...
					$recommendedPHPVersion ?> or later. You can ask your host or your system administrator for
					instructions.
		...
		elseif ($warn_about_maintenance):
			...
			<div class="<?php echo $class_priority_low ?>">
				...
				<p>
					...
					“Security maintenance” phase since <?php echo $securityDateFormatted ?> and has stopped receiving
					bug fixes. It
					will stop receiving security updates on <?php echo $eolDateFormatted ?> at which point it will be
					unsuitable for
					use on a live site.
				</p>
				<p>
					<?php echo $softwareName ?> will stop supporting your version of PHP soon after it becomes
					End-of-Life on
					<?php echo $eolDateFormatted ?>. We recommend that you plan your migration to a newer version of PHP
					before that
					date. We recommend PHP <?php echo $recommendedPHPVersion ?> or later. You can ask your host or your
					system
