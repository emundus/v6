		...
		<div>
			<?php if ($this->isRescueMode): ?>
				<div class="akeeba-block--failure">
					<div>
						<h3><?php echo Text::_('COM_ADMINTOOLS_CONTROLPANEL_RESCUEMODE_HEAD') ?></h3>
						<p>
							<?php echo Text::_('COM_ADMINTOOLS_CONTROLPANEL_RESCUEMODE_MESSAGE'); ?>
						</p>
						<p>
							...
							>
								...
								<?php echo Text::_('COM_ADMINTOOLS_CONTROLPANEL_RESCUEMODE_BTN_HOWTOUNBLOCK'); ?>
							</a>
							<a class="akeeba-btn--red"
							   href="index.php?option=com_admintools&view=ControlPanel&task=endRescue"
							>
								<span class="akion-power"></span>
								<?php echo Text::_('COM_ADMINTOOLS_CONTROLPANEL_RESCUEMODE_BTN_ENDRESCUE'); ?>
							</a>
						</p>
					</div>
				</div>
			...
			<div id="selfBlocked" class="text-center" style="display: none;">
				<a class="akeeba-btn--red--big"
				   href="<?php echo Route::_('index.php?option=com_admintools&view=ControlPanel&task=unblockme'); ?>">
					<span class="akion-unlocked"></span>
					<?php echo Text::_('COM_ADMINTOOLS_CONTROLPANEL_UNBLOCK_ME'); ?>
				</a>
			</div>
		...
		<div>
			<div class="akeeba-panel--default">
				<header class="akeeba-block-header">
					<h3><?php echo Text::_('COM_ADMINTOOLS_LBL_CONTROLPANEL_UPDATES'); ?></h3>
				</header>
			...
			<div id="disclaimer" class="akeeba-block--info">
				<h3><?php echo Text::_('COM_ADMINTOOLS_LBL_CONTROLPANEL_DISCLAIMER'); ?></h3>

				<p>
					<?php echo Text::_('COM_ADMINTOOLS_LBL_CONTROLPANEL_DISTEXT'); ?>
				</p>
			</div>
		</div>
	</div>
