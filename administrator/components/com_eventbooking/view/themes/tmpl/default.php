				...
				<td>
					<fieldset class="form-horizontal options-form">
						...
						<table>
							<tr>
								<td>
									<input type="file" name="theme_package" id="theme_package" size="50" class="form-control" /> <input type="button" class="button" id="btn-install-theme" value="<?php echo Text::_('EB_INSTALL'); ?>" onclick="installPlugin();" />
								</td>
							</tr>
						</table>
					</fieldset>
