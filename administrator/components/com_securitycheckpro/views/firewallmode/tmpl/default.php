...
<form action="<?php echo JRoute::_('index.php?option=com_securitycheckpro&view=firewallmode&'. JSession::getFormToken() .'=1');?>" method="post" name="adminForm" id="adminForm">
...
<div class="box span12">
	<div class="box-header well" data-original-title>
		<i class="icon-list-alt"></i><?php echo ' ' . JText::_('PLG_SECURITYCHECKPRO_MODE_FIELDSET_LABEL'); ?>
		<div class="box-icon">
		...
		<div class="well span4 top-block">
			<legend><?php echo JText::_('COM_SECURITYCHECKPRO_GLOBAL_PARAMETERS') ?></legend>
				<div class="control-group">
					<label for="mode" class="control-label" title="<?php echo JText::_('PLG_SECURITYCHECKPRO_MODE_DESCRIPTION'); ?>"><?php echo JText::_('PLG_SECURITYCHECKPRO_MODE_LABEL'); ?></label>
					<div class="controls">
						<?php echo booleanlist('mode', array(), $this->mode) ?>
					</div>
...
<input type="hidden" name="controller" value="firewallmode" />
</form>