...
<div id="header_manual_check" class="securitycheck-bootstrap-content-box-header">
	<strong><?php echo JText::_( 'COM_SECURITYCHECKPRO_FILEMANAGER_MANUAL_CHECK_HEADER' ); ?></strong>
</div>
...
<div id="warning_message" class="centrado margen-loading texto_14">
	<?php echo JText::_( 'COM_SECURITYCHECKPRO_FILEMANAGER_WARNING_START_MESSAGE' ); ?>
</div>
...
<div id="info-container" class="centrado margen">
	...
	<tr>
		<td colspan="3" class="helpHed_green"><?php echo JText::_( 'COM_SECURITYCHECKPRO_FILEMANAGER_CHECK_STATUS' ); ?></td>
	</tr>
	<tr>
...
<div id="header_check_result" class="header_check_result margen">
	<strong><?php echo JText::_( 'COM_SECURITYCHECKPRO_FILEMANAGER_CHECK_RESULT_HEADER' ); ?></strong>
</div>
<div id="summarytable" class="centrado margen">
<table summary="File check summary" class="sofT margen" cellspacing="0">
<tr>
	<td colspan="3" class="helpHed"><?php echo JText::_( 'COM_SECURITYCHECKPRO_FILE_CHECK_RESUME' ); ?></td>
</tr>
<tr>
	<td class="helpHed"><?php echo JText::_( 'COM_SECURITYCHECKPRO_FILEMANAGER_LAST_CHECK' ); ?></td>
	<td class="helpHed"><?php echo JText::_( 'COM_SECURITYCHECKPRO_FILEMANAGER_FILES_SCANNED' ); ?></td>
	<td class="helpHed"><?php echo JText::_( 'COM_SECURITYCHECKPRO_FILEMANAGER_FILES_FOLDERS_INCORRECT_PERMISSIONS' ); ?></td>	
</tr>
<tr>
