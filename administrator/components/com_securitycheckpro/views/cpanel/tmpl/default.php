...
include JPATH_ADMINISTRATOR.'/components/com_securitycheckpro/helpers/cpanel.php';
?>
			...
			<div class="modal-content">
			  ...
			  <div class="modal-body">	
				...
				<div class="modal-footer" id="div_boton_subida">
					<button id="geoblock_button" class="btn btn-dark" type="button"><?php echo JText::_( 'COM_SECURITYCHECKPRO_GO_TO_GEOBLOCK' ); ?></button>
					<button id="automatic_updates_geoblock_button" class="btn btn-info" type="button"><?php echo JText::_( 'COM_SECURITYCHECKPRO_AUTOMATIC_UPDATES_GEOBLOCK' ); ?></button>
				</div>			  
			</div>
		  </div>
		</div>
