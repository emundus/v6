...
final class RequestUtil
{
    ...
    static function buildPostBody($params, $type="json")
    {
     ...
     * @throws Exception
     */
    static function doPost($clientIdentifier, $accessToken, $host, $path, $headers= array(), $params = null)
    {
    ...
    static function doPostWithSpecificAuth($clientIdentifier, $authHeaderValue, $userLocale, $host, $path, $params = null)
    {
        ...
        $curl->set(CURLOPT_POST, true);
        $curl->set(CURLOPT_POSTFIELDS, self::buildPostBody($params,'array'));
