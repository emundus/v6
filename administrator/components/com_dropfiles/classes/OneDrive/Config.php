...
/**
 * A class to contain the library configuration for the OneDrive API client.
 */
class OneDrive_Config
{
  ...
  /**
   * Create a new OneDrive_Config. Can accept an ini file location with the
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'auth_class'    => 'OneDrive_Auth_OAuth2',
      'io_class'      => self::USE_AUTO_IO_SELECTION,
      'cache_class'   => 'OneDrive_Cache_File',
      'logger_class'  => 'OneDrive_Logger_Null',

      // Don't change these unless you're working against a special development
      // or testing environment.
      'base_path' => 'https://api.onedrive.com',

      // Definition of class specific values, like file paths and so on.
      'classes' => array(
        'OneDrive_IO_Abstract' => array(
          'request_timeout_seconds' => 100,
        ),
        'OneDrive_Logger_Abstract' => array(
          'level' => 'debug',
          'log_format' => "[%datetime%] %level%: %message% %context%\n",
          'date_format' => 'd/M/Y:H:i:s O',
          'allow_newlines' => true
        ),
        'OneDrive_Logger_File' => array(
          'file' => 'php://stdout',
          'mode' => 0640,
          'lock' => false,
        ),
        'OneDrive_Http_Request' => array(
          ...
          'enable_gzip_for_uploads' => self::GZIP_UPLOADS_ENABLED,
        ),
        // If you want to pass in OAuth 2.0 settings, they will need to be
        // structured like this.
        'OneDrive_Auth_OAuth2' => array(
        ...
        'OneDrive_Service_Exception' => array(
          'retry_map' => array(
        ...
        'OneDrive_Cache_File' => array(
          'directory' => sys_get_temp_dir() . '/OneDrive_Client'
        )
      ),
    );
   ...
   * the hd values within an id token (@see OneDrive_Auth_LoginTicket) after sign
