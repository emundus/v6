 ...
 * with the `OneDrive_Logger_Psr::setLogger()` method.
 */
class OneDrive_Logger_Psr extends OneDrive_Logger_Abstract
{
  /**
   ...
   */
  public function __construct(OneDrive_Client $client, /*Psr\Log\LoggerInterface*/ $logger = null)
  {
