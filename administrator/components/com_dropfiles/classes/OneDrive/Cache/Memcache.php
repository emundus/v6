 ...
 */
class OneDrive_Cache_Memcache extends OneDrive_Cache_Abstract
{
  ...
  public function __construct(OneDrive_Client $client)
  {
    if (!function_exists('memcache_connect') && !class_exists("Memcached")) {
      ...
      throw new OneDrive_Cache_Exception($error);
    }
   ...
   * @param string $key
   * @param string $value
   * @throws OneDrive_Cache_Exception
   */
  public function set($key, $value)
  {
    ...
    if ($rc == false) {
      ...
      throw new OneDrive_Cache_Exception("Couldn't store data in cache");
    }
