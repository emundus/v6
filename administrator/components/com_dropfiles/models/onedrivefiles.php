...
/**
 * Class DropfilesModelOneDrivefiles
 */
class DropfilesModelOneDrivefiles extends JModelLegacy
{
    /**
     ...
     *
     * @param string $id_file Onedrive file id
     *
     ...
     *
     * @param string $catid    Onedrive category id
