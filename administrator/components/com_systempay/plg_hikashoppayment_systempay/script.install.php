...
class plghikashoppaymentsystempayInstallerScript
{
    /**
    ...
    function postflight($route, $adapter)
    {
        ...
        JFile::move('systempay_j3.xml', 'systempay.xml', $path);
    }
    ...
    function preflight($type, $adapter)
    {
        if ($type === 'uninstall') {
            ...
            if (JFile::exists($targetFolder . DS . 'systempay_cards.png')) {
                JFile::delete($targetFolder . DS . 'systempay_cards.png');
            }

            if (JFile::exists($targetFolder . DS . 'systempay.png')) {
                JFile::delete($targetFolder . DS . 'systempay.png');
            }
        }
    }
}
