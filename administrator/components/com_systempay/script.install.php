...
if (! class_exists('com_systempayInstallerScript')) {
    class com_systempayInstallerScript
    {
        ...
        function install()
        {
            JInstaller::getInstance()->install(realpath(dirname(__FILE__)) . DS . 'plg_hikashoppayment_systempay');

            if (self::$plugin_features['multi']) {
                JInstaller::getInstance()->install(realpath(dirname(__FILE__)) . DS . 'plg_hikashoppayment_systempaymulti');
            }
...
if (function_exists('com_install')) {
    ...
    {
        $installClass = new com_systempayInstallerScript();
