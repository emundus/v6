	...
	<form action="<?php echo (!empty($this->redirect)) ? 'index.php?option=com_users&task=user.login&redirect='.$this->redirect : 'index.php?option=com_users&task=user.login'; ?>" method="post" class="form-validate form-horizontal well">
		<fieldset>
			...
			<div class="control-group">
				...
				<a href="<?php echo JRoute::_('index.php?option=com_users&view=registration&course=' . $this->course . '&cid=' . $this->cid); ?>" class="btn btn-primary em-register">
					<?php echo JText::_('COM_USERS_LOGIN_REGISTER'); ?>
				</a>
				<?php else: ?>
				<a href="<?php echo JRoute::_('index.php?option=com_users&view=registration'); ?>" class="btn btn-primary em-register">
					<?php echo JText::_('COM_USERS_LOGIN_REGISTER'); ?>
				</a>
				<?php endif; ?>
			</div>
