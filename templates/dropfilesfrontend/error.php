...
<head>
    ...
    <link rel="stylesheet"
          ...
          type="text/css"/>
    <?php if ((int) $app->get('debug_lang', '0') === 1 || (int) $app->get('debug', '0') === 1) : ?>
                    ...
                    <div class="row-fluid">
                        <div class="span6">
                            <p>
                                <strong>
                                    <?php
                                    echo JText::_('JERROR_LAYOUT_ERROR_HAS_OCCURRED_WHILE_PROCESSING_YOUR_REQUEST');
                                    ?>
                                </strong>
                            </p>
    ...
    <div class="container<?php echo($params->get('fluidContainer') ? '-fluid' : ''); ?>">
        ...
        <p class="pull-right">
            <a href="#top" id="back-top">
                <?php echo JText::_('TPL_DROPFILES_BACKTOTOP'); ?>
            </a>
        </p>
        <p>
