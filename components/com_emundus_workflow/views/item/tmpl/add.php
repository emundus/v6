...
JText::script('COM_EMUNDUS_WORKFLOW_ESPACE_PLACEHOLDER_LABEL');
JText::script('COM_EMUNDUS_WORKFLOW_ESPACE_PLACEHOLDER_FORM');
JText::script('COM_EMUNDUS_WORKFLOW_ESPACE_PLACEHOLDER_SUPPLEMENTARY_INFORMATION');
JText::script('COM_EMUNDUS_WORKFLOW_ESPACE_MODAL_LABEL_TITLE');
JText::script('COM_EMUNDUS_WORKFLOW_ESPACE_MODAL_FORM_LABEL');
JText::script('COM_EMUNDUS_WORKFLOW_ESPACE_MODAL_INPUT_STATUS_LABEL');
JText::script('COM_EMUNDUS_WORKFLOW_ESPACE_MODAL_OUTPUT_STATUS_LABEL');
JText::script('COM_EMUNDUS_WORKFLOW_ESPACE_MODAL_SUPPLEMENTARY_INFORMATION_LABEL');
