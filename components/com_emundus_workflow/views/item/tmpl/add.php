...
JText::script('COM_EMUNDUS_WORKFLOW_BUTTON_SAVE_PARAMS');
JText::script('COM_EMUNDUS_WORKFLOW_BUTTON_EXIT_PARAMS');

JText::script('COM_EMUNDUS_WORKFLOW_SWEET_ALERT_CONGRATULATION_TITLE');
JText::script('COM_EMUNDUS_WORKFLOW_SWEET_ALERT_SUCCESS_MESSAGE');
JText::script('COM_EMUNDUS_WORKFLOW_SWEET_ALERT_ERROR_TITLE');
JText::script('COM_EMUNDUS_WORKFLOW_SWEER_ALERT_MISSING_PARAMS_MESSAGE');
