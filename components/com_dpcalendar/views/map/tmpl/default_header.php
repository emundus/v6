...
$i = $c->addChild(new Container('search', ['search']))->addChild(new Input('search', 'text', 'search', $this->state->get('filter.search')));
...
DPCalendarHelper::renderLayout(
	...
	array(
		...
		'dateFormat'  => $this->params->get('map_date_format', 'm.d.Y')
	)
);
