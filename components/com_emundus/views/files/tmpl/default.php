			...
			<div class="panel panel-info" id="em-files-filters">
				<div class="panel-heading" style="height:55px">
					...
					<div class="buttons" style="float:right; margin-top:0px">
						...
						<input value="&#xf0c7" type="button" class="btn btn-sm btn-warning" id="save-filter" style="width:50px; font-family: 'Font Awesome 5 Free';" title="<?php echo JText::_('SAVE_FILTER');?>"/>
                        <br/><br/>
					</div>
				</div>
