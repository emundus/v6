...
Text::script('COM_EMUNDUS_RANKING_EXPORT_COLUMN_NAME');
Text::script('COM_EMUNDUS_RANKING_EXPORT_COLUMN_STATUS');
Text::script('COM_EMUNDUS_RANKING_EXPORT_COLUMN_RANKER');
