        ...
        foreach ($this->attachments as $attachment) {
            ...
            if (!$block_upload) {
                ...
                <tr>
                    ...
                    if ($this->show_shortdesc_input) {
                        $div .= '<div class="row"><div class="col-sm-12 em-description"><label><span>'.JText::_('SHORT_DESC').'</span></label><input type="text" class="form-control" name="description" placeholder="'.(($this->required_desc != 0)?JText::_('EMUNDUS_REQUIRED_FIELD'):'').' '.(($this->required_desc != 0)?'required':'').'" /></div></div>';
                    }
