                    ...
                    <li class="em-list-item" id="em-contact-<?= $message_contact->user_id_from; ?>">
                        ...
                        <div class="em-contact">
							<?php if ($message_contact->state == 1) : ?>
                                <p class="unread-contact" id="contact-<?= $message_contact->user_id_from; ?>-name"><i
                                            class="circle outline"
                                            id="unread-icon"></i><?= $message_contact->name_from . " : "; ?></p>
                                <p class='unread-contact'
                                   id="contact-<?= $message_contact->user_id_from; ?>-date"><?= date("d/m/Y", strtotime($message_contact->date_time)); ?></p>
                                <p class="unread-contact contact-message"
                                   id="contact-<?= $message_contact->user_id_from; ?>-message"><?= strip_tags($message_contact->message); ?></p>
							<?php else : ?>
                                <p class="read-contact"
                                   id="contact-<?= $message_contact->user_id_from; ?>-name"><?= $message_contact->name_from . " : "; ?></p>
                                <p class="read-contact"
                                   id="contact-<?= $message_contact->user_id_from; ?>-date"><?= date("d/m/Y", strtotime($message_contact->date_time)); ?></p>
                                <p class='read-contact contact-message'
                                   id="contact-<?= $message_contact->user_id_from; ?>-message"><?= strip_tags($message_contact->message); ?></p>
							<?php endif; ?>
                        </div>
                    </li>
				...
				<?php if ($message_contact->user_id_from == $this->user_id) : ?>
                    <li class="em-list-item" id="em-contact-<?= $message_contact->user_id_to; ?>">
                        ...
                        <div class="em-contact" id="em-contact-<?= $message_contact->user_id_to; ?>">
                            <p class="read-contact"
                               id="contact-<?= $message_contact->user_id_from; ?>-name"><?= $message_contact->name_to . " : "; ?></p>
                            <p class="read-contact"
                               id="contact-<?= $message_contact->user_id_from; ?>-date"> <?= date("d/m/Y", strtotime($message_contact->date_time)); ?></p>
                            <p class="read-contact contact-message"
                               id="contact-<?= $message_contact->user_id_from; ?>-message"><?= strip_tags($message_contact->message); ?></p>
...
<div id="em-chat" class="em-chat-<?= $id; ?>"><img src="media\com_emundus\images\icones\loader-line.gif"
                                                   id="em-loader"/></div>
