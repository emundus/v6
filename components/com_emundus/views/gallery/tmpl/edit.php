...
Text::script('COM_EMUNDUS_GALLERY_DETAILS_TABS_ADD');
Text::script('COM_EMUNDUS_GALLERY_DETAILS_TABS_DELETE');
Text::script('COM_EMUNDUS_GALLERY_DETAILS_TABS_NAME');
Text::script('COM_EMUNDUS_GALLERY_DETAILS_TABS_AVAILABLE_CONTENT');
Text::script('COM_EMUNDUS_GALLERY_DETAILS_TABS_DISPLAY_CONTENT');
Text::script('COM_EMUNDUS_GALLERY_DETAILS_TABS_ADD_FIELD');
Text::script('COM_EMUNDUS_GALLERY_DETAILS_TABS_REMOVE_FIELD');
Text::script('COM_EMUNDUS_GALLERY_DETAILS_TABS_DELETE_TAB_TITLE');
Text::script('COM_EMUNDUS_GALLERY_DETAILS_TABS_DELETE_TAB_TEXT');
