...
JText::script('COM_EMUNDUS_ONBOARD_GALLERY_NO_CAMPAIGNS');
JText::script('COM_EMUNDUS_ONBOARD_GALLERY_NO_CAMPAIGNS_MESSAGE');
...
JText::script('COM_EMUNDUS_ONBOARD_NOGALLERY');
