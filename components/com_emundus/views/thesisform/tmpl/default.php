...
<div class="thesis-edit front-end-edit">
    ...
    <form id="form-thesis" action="<?php echo JRoute::_('index.php?option=com_emundus&task=thesis.save'); ?>"
		...
		<?php } ?>
        <li><?php echo $this->form->getLabel('doctoral_school'); ?>
        ...
        <div class="button-div">
            ...
            <a href="<?php echo JRoute::_('index.php?option=com_emundus&task=thesisform.cancel'); ?>"
