...
<form action="index.php?option=com_emundus&controller=users&task=addgroup" id="em-add-group" class="em-addGroup"
      role="form" method="post">
    <fieldset class="em-addGroup-defineGroup">
        <div class="form-group em-addGroup-defineGroup-name">
            <label class="control-label em-addGroup-defineGroup-description"
                   for="gname"><?= JText::_('COM_EMUNDUS_GROUPS_GROUP_NAME'); ?></label>
            <input type="text" class="form-control" id="gname" name="gname">
        </div>
        <div class="form-group em-addGroup-defineGroup-description">
            <label class="control-label"
                   for="gdescription"><?= JText::_('COM_EMUNDUS_GROUPS_GROUP_DESCRIPTION'); ?></label>
        ...
        <div class="form-group em-addGroup-defineGroup-assocProgram">
            ...
            <select name="gprogs" id="gprogs" data-placeholder="<?= JText::_("COM_EMUNDUS_GROUPS_CHOOSE_PROGRAMME"); ?>"
                    multiple>
