...
if (!empty((array) $this->assoc_files)) : ?>
	<?php foreach ($this->assoc_files->camps as $camp): ?>
        <div class="panel panel-primary em-container-assocFiles <?php if ($this->assoc_files->fnumInfos['fnum'] == $camp->fnum) {
			echo 'current-file';
		} ?>">
            <div class="panel-heading em-container-assocFiles-heading">
                <div class="panel-title">
                    <a style="text-decoration: none" data-toggle="collapse" data-parent="#accordion"
                       href="#<?php echo $camp->fnum ?>-collapse" onclick="openAccordion('<?php echo $camp->fnum ?>')">
            ...
            <div id="<?php echo $camp->fnum ?>-collapse-item"
                ...
                <div class="panel-body em-container-assocFiles-body em-mt-8">
                    <div>
                        <ul>
                            <li class="em-mb-4">
                                <span><strong><?php echo JText::_('COM_EMUNDUS_ACADEMIC_YEAR') ?> : </strong><?php echo $camp->year ?></span>
                            </li>
                            <li class="em-mb-4">
                                <span><strong><?php echo JText::_('COM_EMUNDUS_PROGRAMME') ?> : </strong><?php echo $camp->training ?></span>
                            </li>
                            <li class="em-mb-4">
                                <span><strong><?php echo JText::_('COM_EMUNDUS_FILE_F_NUM') ?> : </strong><?php echo $camp->fnum ?></span>
                            </li>

							<?php if ($camp->submitted == 1): ?>
                                <li class="em-mb-4">
                                    <span><strong><?php echo JText::_('COM_EMUNDUS_APPLICATION_DATE_SUBMITTED') ?> : </strong><?php echo JFactory::getDate($camp->date_submitted)->format(JText::_('DATE_FORMAT_LC2')); ?></span>
                                </li>
							<?php endif; ?>
                        </ul>
