				...
				<?php else : ?>
					<?php foreach ($this->messages as $message) : ?>
                        <div class='panel panel-default em-container-mail-content'>
                            <div class="panel-heading em-container-mail-content-heading"><h3><?= $message->subject; ?>
                                    <small> <?= JText::_('COM_EMUNDUS_EMAILS_MESSAGE_FROM') . ': ' . JFactory::getUser($message->user_id_from)->name . ' ' . date('d/m/Y H:i:s', strtotime($message->date_time)); ?> </small>
                                </h3></div>
