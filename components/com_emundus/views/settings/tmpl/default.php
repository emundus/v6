...
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_RANKING_GENERAL');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_MENU_RANKING');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_MENU_RANKING_DESC');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_RANKING_ADD_HIERARCHY');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_RANKING_SAVE_HIERARCHY');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_RANKING_DELETE_HIERARCHY');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_RANKING_HIERARCHIES');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_RANKING_HIERARCHY_EDIT_STATUS');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_RANKING_HIERARCHY_VISIBLE_STATUS');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_RANKING_HIERARCHY_VISIBLE_HIERARCHIES');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_RANKING_HIERARCHY_PROFILES');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_RANKING_HIERARCHY_PUBLISHED');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_RANKING_SELECT_VALUE');
