...
//filter for domain
$selected_domain = $input->get('filter_domain',$this->state->get('filter.domain'));
$domains = @EmundusHelperFiles::getElementsValuesOther(2262);
$values = $domains->sub_values;
$labels = $domains->sub_labels;
$options = array();
...
<fieldset id="filter-bar">
	<div class="filter-search fltlft">
		<?php if ($filters) : ?>
            ...
            <?php
            echo JText::_('COM_EMUNDUS_THESIS_DOMAINE') . " " . JHTML::_('select.genericlist', $options, 'filter_domain', 'class="inputbox"', 'value', 'text', $selected_domain);
            ?>
