    ...
    <div class="filter-search fltlft">
		<?php if ($filters) : ?>
            ...
            <input type="text" name="filter_search" id="filter_search"
                   ...
                   title="<?php echo JText::_('COM_EMUNDUS_THESIS_SEARCH'); ?>"/>
			...
			?>
            <button type="submit"
                    class="btn btn-primary btn-xs"><?php echo JText::_('JSEARCH_FILTER_SUBMIT'); ?></button>
            <button type="button" class="btn btn-warning btn-xs"
                    onclick="document.id('filter_search').value = '';document.id('doctoral_school').value = ''; this.form.submit();"><?php echo JText::_('JSEARCH_FILTER_CLEAR'); ?></button>
