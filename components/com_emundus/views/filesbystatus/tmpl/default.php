            ...
            <div class="panel panel-info em-containerFilter" id="em-files-filters">
                <div class="panel-heading em-containerFilter-heading">
                    ...
                    <div class="buttons" style="float:right; margin-top:0px">
                        <input value="&#xe003" type="button" class="btn btn-sm btn-info glyphicon glyphicon-search"
                               name="search" id="search"
                               title="<?php echo JText::_('COM_EMUNDUS_ACTIONS_SEARCH_BTN'); ?>"/>&ensp;
                        <input value="&#xe090" type="button"
                               class="btn btn-sm btn-danger glyphicon glyphicon-ban-circle" name="clear-search"
                               id="clear-search" title="<?php echo JText::_('COM_EMUNDUS_ACTIONS_CLEAR_BTN'); ?>"/>&ensp;
                        <button class="btn btn-sm btn-warning" id="save-filter" style="width:50px;"
                                title="<?php echo JText::_('COM_EMUNDUS_FILES_SAVE_FILTER'); ?>"><i
