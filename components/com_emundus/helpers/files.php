        ...
        if (@$params['profile'] !== NULL) {
            ...
            if (!$hidden) {
                $profile .= '<div class="form-group em-filter" id="o_profiles">
                                    <div class="em_label">
                                    	<label class="control-label em-filter-label">'.JText::_('COM_EMUNDUS_USERS_OTHER_PROFILES').'&ensp; <a href="javascript:clearchosen(\'#select_oprofiles\')"><span class="fas fa-undo" title="'.JText::_('COM_EMUNDUS_FILTERS_CLEAR').'"></span></a></label>
                                    </div>';
            }
        ...
        if (@$params['campaign'] !== NULL) {
            ...
            if (!$hidden) {
                $campaign .= '<div id="campaign" class="em-filter">
                            	<div class="em_label">
                            		<label class="control-label em-filter-label">'.JText::_('COM_EMUNDUS_CAMPAIGN').'&ensp; <a href="javascript:clearchosen(\'#select_multiple_campaigns\')"><span class="fas fa-undo" title="'.JText::_('COM_EMUNDUS_FILTERS_CLEAR').'"></span></a></label>
                            	</div>
                          		<div class="em_filtersElement">';
            }
        ...
        if ($params['schoolyear'] !== NULL) {
            ...
            if (!$hidden) {
                $schoolyear .= '<div id="schoolyear" class="em-filter">
                                    <div class="em_label">
                                    	<label class="control-label em-filter-label">'.JText::_('COM_EMUNDUS_PROFILES_SCHOOLYEARS').' &ensp;<a href="javascript:clearchosen(\'#select_multiple_schoolyears\')"><span class="fas fa-undo" title="'.JText::_('COM_EMUNDUS_FILTERS_CLEAR').'"></span></a></label>
                                    </div>
                                   <div class="em_filtersElement">';
            }
        ...
        if (@$params['programme'] !== NULL) {
            ...
            if (!$hidden) {
                $programme .= '<div id="programme" class="em-filter">
                    <div class="em_label">
                    	<label class="control-label em-filter-label">'.JText::_('COM_EMUNDUS_PROGRAMME').'&ensp;<a href="javascript:clearchosen(\'#select_multiple_programmes\')"><span class="fas fa-undo" title="'.JText::_('COM_EMUNDUS_FILTERS_CLEAR').'"></span></a></label>
                    </div>
                    <div class="em_filtersElement">';
            }
        ...
        if (@$params['status'] !== NULL) {
            ...
            if (!$hidden) {
                $status .= '<div class="em_filters em-filter" id="status">
                    <div class="em_label">
                    	<label class="control-label em-filter-label">'.JText::_('COM_EMUNDUS_STATUS').'&ensp; <a href="javascript:clearchosen(\'#select_multiple_status\')"><span class="fas fa-undo" title="'.JText::_('COM_EMUNDUS_FILTERS_CLEAR').'"></span></a></label>
                    </div>
                    <div class="em_filtersElement">';
            }
	    ...
	    if (@$params['group_assoc'] !== NULL) {
		    ...
		    if (!$hidden) {
			    $group_assoc .= '<div id="group_assoc" class="em-filter">
                    		<div class="em_label">
                    			<label class="control-label em-filter-label">'.JText::_('COM_EMUNDUS_ASSOCIATED_GROUPS').'&ensp; <a href="javascript:clearchosen(\'#select_multiple_group_assoc\')"><span class="fas fa-undo" title="'.JText::_('COM_EMUNDUS_FILTERS_CLEAR').'"></span></a></label>
                            </div>
                    		<div class="em_filtersElement">';
		    }
                ...
                $group .= '<div id="group">
                    		<div class="em_label">
                    			<label class="control-label em_filters_other_label">'.JText::_('COM_EMUNDUS_USERS_GROUP_FILTER').' &ensp;
                    				<a href="javascript:clearchosen(\'#select_multiple_groups\')"><span class="fas fa-undo" title="'.JText::_('COM_EMUNDUS_FILTERS_CLEAR').'"></span></a>
                    			</label>
                            </div>
                    		<div class="em_filtersElement">';
            }
                ...
                $institution .= '<div id="group">
                    				<div class="em_label">
                    					<label class="control-label em_filters_other_label">'.JText::_('COM_EMUNDUS_FILES_UNIVERSITY').' &ensp;
                    						<a href="javascript:clearchosen(\'#select_multiple_institutions\')"><span class="fas fa-undo" title="'.JText::_('COM_EMUNDUS_FILTERS_CLEAR').'"></span></a>
                    					</label>
                                    </div>
                    				<div class="em_filtersElement">';
            }
