...
//Messenger
JText::script('COM_EMUNDUS_MESSAGES_TITLE');
JText::script('COM_EMUNDUS_MESSAGES_SEND_DOCUMENT');
JText::script('COM_EMUNDUS_MESSAGES_ASK_DOCUMENT');
JText::script('COM_EMUNDUS_MESSAGES_DROP_HERE');
JText::script('COM_EMUNDUS_PLEASE_SELECT');
JText::script('COM_EMUNDUS_MESSAGES_SEND');
JText::script('COM_EMUNDUS_MESSAGES_WRITE_MESSAGE');
JText::script('COM_EMUNDUS_MESSAGES_TYPE_ATTACHMENT');
