  ...
  <span :id="'dashboardTool'">
    ...
    >
      <div class="em-modal-header">
        <div class="em-flex-space-between em-flex-row em-pointer" @click.prevent="$modal.hide('dashboardTool')">
...
export default {
  ...
  data() {
    return {
      ...
      menus: [
        {
          title: "COM_EMUNDUS_ONBOARD_DASHBOARD_TOOL_WIDGETS",
          index: 1
        },
        {
          title: "COM_EMUNDUS_ONBOARD_DASHBOARD_TOOL_DEFAULT_CONFIG",
          index: 2
        },
      ],
