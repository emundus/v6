  ...
  <div id="comments">
        ...
        <div class="em-flex-row em-flex-space-between">
          ...
          <div v-click-outside="hideOptions">
            ...
            <div v-if="show_options === comment.id" class="em-comment-option">
              <span class="em-pointer comment-delete"
    ...
    <div class="em-flex-row em-flex-center em-mt-24" v-if="adding_comment">
      <div class="em-input-card em-w-50">
        <div>
          <span class="material-icons-outlined em-pointer em-float-right em-mb-4"
        ...
        <div class="em-mt-8">
          <button class="em-primary-button em-w-auto em-float-right" @click="saveComment">
    ...
    <div v-if="$props.access.c && !adding_comment" class="em-flex-row em-flex-center em-mt-32">
      <button class="em-primary-button em-w-auto" @click="adding_comment = true;">
