    ...
    <div>
      ...
      <transition name="slide-right">
        <div class="em-grid-3" v-if="menuHighlight === 0">
          <div style="background: var(--neutral-0);" v-for="(menu,index) in displayedMenus" :key="'menu_' + menu.index" class="em-shadow-cards em-hover-s-scale" v-wave @click="changeMenu(menu)">
