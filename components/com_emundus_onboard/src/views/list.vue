  ...
  <div id="list">
    ...
    <div v-show="total > 0 || type == 'files'">
      <div v-show="total > 0" class="buttonSelectDeselect">
        <button
          @click="!isEmpty ? selectAllItem() : deselectItem()"
          class="btn-selectAll"
...
export default {
  ...
  data: () => ({
    ...
    noCampaign: Joomla.JText._("COM_EMUNDUSONBOARD_NOCAMPAIGN"),
    noProgram: Joomla.JText._("COM_EMUNDUSONBOARD_NOPROGRAM"),
    noEmail: Joomla.JText._("COM_EMUNDUSONBOARD_NOEMAIL"),
    noForm: Joomla.JText._("COM_EMUNDUSONBOARD_NOFORM"),
    noFiles: Joomla.JText._("COM_EMUNDUSONBOARD_NOFILES"),
  ...
  created() {
    ...
    if (this.typeForAdd == "formulaire") {
      this.typeForAdd = "form";
    }
