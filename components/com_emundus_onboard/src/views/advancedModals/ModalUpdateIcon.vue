  ...
  <span :id="'modalUpdateIcon'">
    ...
    >
      <div class="fixed-header-modal">
            <div class="topright">
              <button type="button" class="btnCloseModal" @click.prevent="$modal.hide('modalUpdateIcon')">
...
`;
  ...
  export default {
    ...
    data() {
      return {
        dropzoneOptions: {
          url: 'index.php?option=com_emundus_onboard&controller=settings&task=updateicon',
          maxFilesize: 10,
          maxFiles: 1,
        ...
        updateIcon: Joomla.JText._("COM_EMUNDUS_ONBOARD_UPDATE_ICON"),
