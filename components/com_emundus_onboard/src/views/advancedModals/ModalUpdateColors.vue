    ...
    data() {
      return {
        presets:[
          ...
          {primary:'#7A7D7F',secondary:'#000000'},
          {primary:'#000000',secondary:'#DA3832'},
          {primary:'#131C2D',secondary:'#5AA6DC'},
          {primary:'#6CAF57',secondary:'#5AA6DC'},
          {primary:'#479CAC',secondary:'#EEBC42'},
        ],
