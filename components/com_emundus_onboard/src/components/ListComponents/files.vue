...
export default {
  ...
  data() {
    return {
      ...
      Lastname: Joomla.JText._("COM_EMUNDUS_ONBOARD_DOSSIERS_LASTNAME"),
      Firstname: Joomla.JText._("COM_EMUNDUS_ONBOARD_DOSSIERS_FIRSTNAME"),
      Campaign: Joomla.JText._("COM_EMUNDUS_ONBOARD_DOSSIERS_CAMPAIGN"),
      Program: Joomla.JText._("COM_EMUNDUS_ONBOARD_DOSSIERS_PROGRAM"),
      Status: Joomla.JText._("COM_EMUNDUS_ONBOARD_DOSSIERS_STATUS"),
      Start: Joomla.JText._("COM_EMUNDUS_ONBOARD_DOSSIERS_START"),
      End: Joomla.JText._("COM_EMUNDUS_ONBOARD_DOSSIERS_END"),
      Created_at: Joomla.JText._("COM_EMUNDUS_ONBOARD_DOSSIERS_CREATED"),
      Profile_name: Joomla.JText._("COM_EMUNDUS_ONBOARD_DOSSIERS_PROFILE"),
      CloseButton: Joomla.JText._("COM_EMUNDUS_ONBOARD_DOSSIERS_CLOSE"),
      ResetButton: Joomla.JText._("COM_EMUNDUS_ONBOARD_DOSSIERS_RESET"),
      RemoveButton: Joomla.JText._("COM_EMUNDUS_ONBOARD_DOSSIERS_REMOVE"),
      noDossiers: Joomla.JText._("COM_EMUNDUS_ONBOARD_NOFILES")
    };
  },
