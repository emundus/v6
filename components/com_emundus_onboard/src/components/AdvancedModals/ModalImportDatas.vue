    ...
    export default {
        ...
        data() {
            return {
                ...
                NameRequired: Joomla.JText._("COM_EMUNDUS_ONBOARD_LASTNAME_REQUIRED"),
                Translate: Joomla.JText._("COM_EMUNDUS_ONBOARD_TRANSLATE_ENGLISH"),
                Columns: Joomla.JText._("COM_EMUNDUS_ONBOARD_COLUMNS"),
                Description: Joomla.JText._("COM_EMUNDUS_ONBOARD_ADDCAMP_DESCRIPTION"),
                ImportDatasTable: Joomla.JText._("COM_EMUNDUS_ONBOARD_IMPORT_DATAS"),
                Retour: Joomla.JText._("COM_EMUNDUS_ONBOARD_ADD_RETOUR"),
                Continuer: Joomla.JText._("COM_EMUNDUS_ONBOARD_NEXT"),
                ...
                LeastOneColumnRequired: Joomla.JText._("COM_EMUNDUS_ONBOARD_LEAST_ONE_COLUMN_REQUIRED"),
                FileTypeInvalid: Joomla.JText._("COM_EMUNDUS_ONBOARD_INVALID_FILE_TYPE"),
            };
        },
        methods: {
            beforeClose(event) {
