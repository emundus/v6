<template>
  <div>
    <h2 class="em-h4 em-mb-8">{{ translate('COM_EMUNDUS_ONBOARD_TRANSLATION_TOOL_ORPHELINS') }}</h2>
          ...
          <div class="em-mb-32 em-neutral-100-box">
            <div class="justify-content-between em-mt-16 em-grid-50">
              ...
              <div>
                ...
                <a class="em-pointer em-blue-500-color em-mt-16 em-font-size-12" @click="saveTranslation(translation.override,translation,index)">{{ translate('COM_EMUNDUS_ONBOARD_TRANSLATION_TOOL_ORPHELIN_CONFIRM_TRANSLATION') }}</a>
              </div>
            </div>
          </div>
        </div>
