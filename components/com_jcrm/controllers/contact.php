...
class JcrmControllerContact extends JcrmController {
    ...
    public function edit() {
        ...
        // Get the model.
        $model = $this->getModel('Contact', 'JcrmModel');
	...
	public function addcontact()
	{
		...
		$model = new JcrmModelContact();
		$contact = $model->addContact($request_body);
		echo json_encode((object)$contact);
		exit();
	}
	...
	public function update()
	{
		$request_body = (object) json_decode(file_get_contents('php://input'));
		$model = new JcrmModelContact();
		$contact = $model->update($request_body);
		echo json_encode((object)$contact);
		exit();
	}
	...
	public function addgroup()
	{
		...
		$model = new JcrmModelContact();
		$group = new stdClass();
		$group_id = $model->addGroup($request_body);
	...
	public function updategroup()
	{
		$request_body = (object) json_decode(file_get_contents('php://input'));
		$model = new JcrmModelContact();
		$contact = $model->updateGroup($request_body);
		echo json_encode((object)$contact);
		exit();
	}
	...
	public function deletegroup()
	{
		$request_body = (object) json_decode(file_get_contents('php://input'));
		$model = new JcrmModelContact();
		$contact = $model->deleteGroup($request_body->id);
		echo json_encode((object)$contact);
		exit();
	}
	...
	public function deletecontact()
	{
		$request_body = (object) json_decode(file_get_contents('php://input'));
		$model = new JcrmModelContact();
		$contact = $model->deleteContact($request_body);
		echo json_encode((object)$contact);
		exit();
	}
}
