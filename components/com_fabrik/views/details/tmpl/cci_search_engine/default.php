...
try {
    $result = $http->get('https://ccirochefort.evaluations.ovh/Facett3?Societe=1&Mode=Evaluations&ExtractionDonnees=TauxSatisfaction&CodeProduit='.$this->data['jos_emundus_setup_programmes___code_raw']);
