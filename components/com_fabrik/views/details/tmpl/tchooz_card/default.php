  ...
  <?php if (preg_match('/show_details_content/', $notes, $matches)) :?>
    <div>
        <div class="mod_emundus_campaign__details_content em-border-neutral-300 em-mb-24">
            ...
            <a class="btn btn-primary em-w-100 em-applicant-default-font" role="button" href="<?php if (preg_match('/apply_url="(.*)"/', $notes, $matches)) :  echo $matches[1]; endif;?>" data-toggle="sc-modal"><?php echo JText::_('COM_FABRIK_EDITLABEL'); ?></a>
        </div>
    </div>
    <?php endif; ?>
</div>
