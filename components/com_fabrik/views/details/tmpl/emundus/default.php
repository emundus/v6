...
<div class="page-header em-mb-12 em-flex-row em-flex-space-between">
    ...
    <?php if (!empty($model->data['rowid'])) : ?>
        <button class="em-secondary-button em-w-auto">
            <a target="_blank" href="index.php?option=com_fabrik&view=form&formid=<?php echo $form->id ?>&rowid=<?php echo $model->data['rowid'] ?>">
...
foreach ($this->groups as $group) :
	...
	?>
		...
		<div class="em-mt-16 <?php echo $group->class; ?>" id="group<?php echo $group->id;?>" style="<?php echo $group->css;?>">
