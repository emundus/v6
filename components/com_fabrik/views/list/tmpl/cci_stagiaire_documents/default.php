                        ...
                        <div class="accordion-container accordion-container-<?php echo $this->table->renderid; ?>">
                            <div class="article-title article-title-<?php echo $this->table->renderid; ?>">
                                <div class="article-name">
                                    ...
                                    <h2><?php echo $row->data->jos_emundus_setup_teaching_unity___label_raw;?></h2>
                                    <span class="formation-date">
                                        <?php
                                            setlocale(LC_ALL, 'fr_FR.utf8');

                                            $date_start = $row->data->jos_emundus_setup_teaching_unity___date_start_raw;
                                            $date_end = $row->data->jos_emundus_setup_teaching_unity___date_end_raw;
