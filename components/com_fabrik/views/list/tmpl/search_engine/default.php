                                    ...
                                    <tr>
                                        <td>
                                            <div class="em-search-engine-div-data">
                                                <p><?php if (!empty($region)) :?>En région <i><b><?php echo $region; ?></b></i>,<?php endif; if (!empty($department)) :?> dans le département <i><b><?php echo $department; ?></b></i>, un <?php elseif (empty($region)) :?> Un <?php endif; ?><i><b><?php echo $chercheur; ?></b></i> cherche <i><b><?php echo $cherches; ?></b></i> sur le thème <i><b><?php echo $themes; ?></b></i></p>
