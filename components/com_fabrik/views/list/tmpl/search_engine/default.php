                                    ...
                                    <tr>
                                        <td>
                                            <div class="em-search-engine-div-data">
                                                <p><?php if (!empty($region)) :?>En région <i><b><?php echo $region; ?></b></i>,<?php endif; if (!empty($department)) :?> <?php if (empty($region)) :?> Dans <?php else :?> dans <?php endif; ?> le département <i><b><?php echo $department; ?></b></i>, un <?php endif; if (empty($region) && empty($department)) :?> Un <?php endif; ?><i><b><?php echo $chercheur; ?></b></i> cherche <i><b><?php echo $cherches; ?></b></i> sur le thème <i><b><?php echo $themes; ?></b></i></p>
