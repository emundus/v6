...
?>
<form class="fabrikForm form-search" action="<?= $this->table->action;?>" method="post" id="<?= $this->formid;?>" name="fabrikList" data-id="<?= $form_id; ?>">
                        ...
                        for ($i = 1; $i <= count($group); $i++) {
                                ...
                                <div class="card">
                                    <div class="cardContainer">
                                        ...
                                        <div class="cardContainerContent">
                                            ...
                                            <p><span class='intitule'><?= JText::_('POLE'); ?>:</span> <?= $group[$i]->data->$pole; ?></p>
                                        </div>
                                    </div>
                                    <a class="btn btn-connexion" href="connexion-candidater?course=<?= $training;?>&cid=<?=$cid;?>&Itemid=2700"><?= JText::_('APPLY_NOW'); ?></a>
                                </div>
                            ...
                            <?php else :?>
                                <div class="card">
                                    ...
                                    <a class="btn btn-connexion" href="deposer-un-dossier?course=<?= $training;?>&cid=<?=$cid;?>&itemId=2879"><?= JText::_('SUBMIT_APPLICATION_FILE'); ?></a>
                                </div>
                            <?php endif;
                        }
                    }
