...
<div class="emundus-form p-6">
    <form enctype="multipart/form-data" action="<?php echo $action ?>" method="post" name="adminForm" id="fabrik-form" class="form-validate fabrikForm">
        ...
        ?>
        <label for="campaign_id" class="control-label"><?= JText::_('COM_EMUNDUS_CAMPAIGN') ?></label>
        ...
        <div class="em-flex-row-justify-end em-w-100">
            <input type="submit" class="btn btn-primary button" value="<?php echo FText::_('COM_FABRIK_IMPORT_CSV')?>" />
        </div>
    </form>
</div>
