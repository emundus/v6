...
/**
 * Class DropfilesModelFrontonedrive
 */
class DropfilesModelFrontonedrive extends JModelLegacy
{
    /**
     ...
     * @since  version
     */
    public function getTable($type = 'Onedrive', $prefix = 'DropfilesTable', $config = array())
    {
        return JTable::getInstance($type, $prefix, $config);
    }

    /**
     * Save file OneDrive to database
     *
    ...
    public function getItems($catid, $ordering = 'ordering', $dir = 'asc')
    {
        ...
        $query .= ' custom_icon FROM #__dropfiles_onedrive_files WHERE catid=' . $dbo->quote($catid);
    ...
    {
        $dbo = $this->getDbo();
        $query = 'UPDATE #__dropfiles_onedrive_files SET hits=(hits+1) WHERE file_id=' . $dbo->quote($file_id);
    ...
    public function getFile($id)
    {
        ...
        $query->from('#__dropfiles_onedrive_files');
    ...
    /**
     * Method get all onedrive Categories
     *
     * @return mixed
     */
    public function getAllOneDriveCategories()
    {
        $dbo = $this->getDbo();
    ...
    /**
     * Method get all onedrive files in database
     *
     * @return array
     */
    public function getAllOneDriveFilesInDb()
    {
        $dbo = $this->getDbo();
