...
?>
<form action="<?php echo JRoute::_('index.php?option=com_dropfiles&view=users&layout=modal&tmpl=component&groups='
    . $input->get('groups', '', 'BASE64') . '&excluded=' . $input->get('excluded', '', 'BASE64')); ?>"
