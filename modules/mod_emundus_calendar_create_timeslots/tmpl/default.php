...
<div class="col-md-2">
    <button type="button" data-toggle="modal" data-target="#em-modal-timeslots" class="btn btn-success"><?php echo JText::_("MOD_EM_TIMESLOTS_ADD"); ?></button>
</div>

<div class="modal fade" id="em-modal-timeslots" tabindex="-1" style="z-index:99999" role="dialog" aria-labelledby="em-modal-actions-title">
                ...
                <form>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon" for="em-timeslots-start-date"><?php echo JText::_("MOD_EM_TIMESLOTS_START_DATE"); ?></span>
                            <input id="em-timeslots-start-date" type="date" value="<?php echo date('Y-m-d'); ?>">
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon" for="em-timeslots-end-date"><?php echo JText::_("MOD_EM_TIMESLOTS_END_DATE"); ?></span>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon" for="em-timeslots-start-time"><?php echo JText::_("MOD_EM_TIMESLOTS_START_TIME"); ?></span>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon" for="em-timeslot-length"><?php echo JText::_("MOD_EM_TIMESLOTS_LENGTH"); ?></span>
                            <input id="em-timeslot-length" type="number" value="50">
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon" for="em-pause-length"><?php echo JText::_("MOD_EM_PAUSE_LENGTH"); ?></span>
                            <input id="em-pause-length" type="number" value="10">
                        </div>
                    </div>


                    <button type="button" onclick="postTimeslots()" class="btn btn-primary" id="btnTimeslots" name="btnAddtimeslots"><?php echo JText::_("MOD_EM_TIMESLOTS_SUBMIT"); ?></button>
                </form>
