...
if ($item->menu_image) {
    ...
    if($item->deeper) {
        $item->title[0]==='P'? $linktype = '<img src="/images/emundus/menus/parameters.png" alt="'.$item->title.'" height="50" width="50" /><span class="image-title" style="display: none;opacity: 0">'.$item->title.'</span>':
