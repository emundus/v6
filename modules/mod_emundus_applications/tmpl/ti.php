...
<?php elseif (isset($admission_fnum) && ($position_add_application == 0 || $position_add_application == 2)) : ?>
    <a class="btn btn-success"
       href="index.php?option=com_fabrik&view=form&formid=272&Itemid=2720&usekey=fnum&rowid=<?= $admission_fnum ?>"><span
                class="icon-plus-sign"> <?= JText::_('MOD_EMUNDUS_APPLICATIONS_SEND_COMPLETE_ADMISSION'); ?></span></a>
<?php endif; ?>
<hr>
			...
			<?php if ($state == '1' || $show_remove_files == 1 && $state == '-1' || $show_archive_files == 1 && $state == '0') : ?>
                <div class="row" id="row<?= $application->fnum; ?>">
                    <div class="col-xs-6 col-md-4">
                        <p class="">
                            <a href="<?= JRoute::_((($absolute_urls === 1) ? '/' : '') . 'index.php?option=com_emundus&task=openfile&fnum=' . $application->fnum . '&Itemid=' . $Itemid . '#em-panel'); ?>">
                    ...
                    <div class="col-xs-6 col-md-4">
                        ...
                        <a class="btn btn-warning btn-xs"
                           href="<?= JRoute::_((($absolute_urls === 1) ? '/' : '') . 'index.php?option=com_emundus&task=openfile&fnum=' . $application->fnum . '&redirect=' . base64_encode($first_page[$application->fnum]['link'])); ?>"
                           role="button">
                    ...
                    <div class="col-xs-6 col-md-2">
						<?= JText::_('MOD_EMUNDUS_APPLICATIONS_STATUS'); ?> : <span
                                class="label label-<?= $application->class; ?>"><?= $application->value; ?></span>
