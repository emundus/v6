            ...
            <?php if ($show_remove_files == 1 && $state == '-1' || $show_archive_files == 1 && $state == '0') : ?>
                <div class="row" id="row<?= $application->fnum; ?>">
                    ...
                    <div class="col-xs-12 col-md-6 main-page-file-info">
                        ...
                        <a class="btn btn-secondary" role="button" disabled="disabled" data-toggle="tooltip" data-placement="top" title="<?= JText::_('MOD_EMUNDUS_APPLICATION_TOOLTIP_REMOVE_OR_ARCHIVE_FILES'); ?>">
                            <i class="folder open outline icon"></i> <?= JText::_('OPEN_APPLICATION'); ?>
                        </a>
