			...
			if ($display_app) {
				...
				if ($state == '1' || $show_remove_files == 1 && $state == '-1' || $show_archive_files == 1 && $state == '0') : ?>
                    ...
                    <div class="em-flex-row em-flex-space-between">
                        ...
                        <div class="change-wish-number" data-fnum="<?= $application->fnum; ?>"
                             data-wish="<?= $application->wish_number; ?>">
							<?php if ($a_index > 0 && $application->status == 0 && $applications[$a_index - 1]->status == 0): ?>
                                <a href="#"><span
                                            class="material-icons-outlined em-pointer up">keyboard_double_arrow_up</span></a>
							<?php endif; ?>
