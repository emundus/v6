  ...
  <hr>
    ...
    <div class="row" id="row<?php echo $application->fnum; ?>">
        ...
        <div class="col-xs-12 col-md-6 main-page-file-info">
            ...
            <a class="btn btn-secondary" disabled="disabled" data-toggle="tooltip" data-placement="top" title="<?php echo JText::_('MOD_EMUNDUS_APPLICATION_TOOLTIP_REMOVE_OR_ARCHIVE_FILES'); ?>"  role="button">
                <i class="folder open outline icon"></i> <?php echo JText::_('OPEN_APPLICATION'); ?>
            </a>
