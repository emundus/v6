                                            ...
                                            <div class="hover-and-tile-container" id="application_content<?php echo $application->fnum ?>">
                                                        ...
                                                        <div class="em-flex-row em-flex-space-between em-mb-12">
                                                            <div class="flex flex-row gap-2 items-center justify-content-center">
                                                                ...
                                                                <?php if ($show_nb_comments) {
                                                                    ...
                                                                    if ($nb_comments > 0) {
                                                                        ?>
                                                                        <a href="<?= !empty($comments_page_alias) ? '/' . $comments_page_alias . '?tab=comments&ccid=' . $application->application_id . '&fnum=' . $application->fnum : '#'  ?>"  id="actions_button_comment" class="flex flex-row comments-icon-wrapper relative ml-2">
                                                ...
                                                >
		                                            ...
		                                            <?php if (in_array('history', $actions) && ($application->applicant_id === $user->id || $application->show_history == 1)) : ?>
                                                        <a class="em-text-neutral-900 em-pointer em-flex-row"
                                                           href="<?= JRoute::_($history_link->route.'?ccid='. $application->application_id .'&fnum=' . $application->fnum); ?>"
