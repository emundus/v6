                                                        ...
                                                        <div class="em-flex-row em-flex-space-between em-mb-12">
                                                            <div class="flex flex-row gap-2 items-center justify-content-center">
                                                                ...
                                                                <?php if ($show_nb_comments) {
                                                                    ...
                                                                    if ($nb_comments > 0) {
                                                                        ?>
                                                                        <a href="<?= !empty($comments_page_alias) ? '/' . $comments_page_alias . '?ccid=' . $application->application_id . '&fnum=' . $application->fnum : '#'  ?>"  id="actions_button_comment" class="flex flex-row comments-icon-wrapper relative ml-2">
