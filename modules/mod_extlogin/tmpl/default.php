    ...
    <form action="index.php" method="post" name="login" id="form-login-nav">
        <span class="logout">
            ...
            <?php if ($params->get('greeting')) :?>
                <span id="log_username"><?php echo $user->get('firstname'); ?> </span>
            <?php endif; ?>
...
<?php else :?>
    ...
    <form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" name="login" id="form-login-nav" >
        ...
        <?php if (!empty($params->get('pretext'))) :?>
            <h2 class="em_modlgn-pretext"><?php echo $params->get('pretext'); ?></h2>
        <?php endif;  ?>
        ...
        <?php if ($usersConfig->get('allowUserRegistration') && $params->get('registration')) :?>
        ...
        <?php if ($params->get('lost_username')) :?>
