...
JText::script('COM_EMUNDUS_DASHBOARD_PROSPECT_DEMO');
JText::script('COM_EMUNDUS_DASHBOARD_PROSPECT_DEMO_TEXT');
JText::script('COM_EMUNDUS_DASHBOARD_PROSPECT_DEMO_TEXT_2');
JText::script('COM_EMUNDUS_DASHBOARD_PROSPECT_DEMO_ENABLE');
