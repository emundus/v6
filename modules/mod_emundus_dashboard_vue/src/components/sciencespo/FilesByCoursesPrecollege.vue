...
export default {
  ...
  methods: {
    renderFilesByStatus(){
      axios({
        method: "get",
        url: "index.php?option=com_emundus_onboard&controller=dashboard&task=getfilescountbystatusandcoursesprecollege",
        params: {
        ...
        if(this.session === 1){
          title += ' - ' + Joomla.JText._("COM_EMUNDUS_DASHBOARD_1ST_SESSION")
        } else if(this.session === 2){
          title += ' - ' + Joomla.JText._("COM_EMUNDUS_DASHBOARD_2ND_SESSION")
        }
