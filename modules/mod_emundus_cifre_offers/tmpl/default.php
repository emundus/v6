                        ...
                        <div class="em-bottom-space">
                            <div class="em-contact-request-contact">
                                ...
                                <?php if (!empty($offer->offer_from)) : ?>
                                    ...
                                    <div class="em-contact-request-linked-offer-link"><a
                                                href="<?php echo JRoute::_(JURI::base() . "consultez-les-offres/details/299/" . $offer->offer_from->search_engine_page); ?>"><?php echo $offer->offer_from->titre; ?></a></div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div id="em-buttons-<?php echo $offer->link_id; ?>">
                                <?php if ($offer->state == '1') : ?>
                                    <button type="button" class="btn btn-primary"
                                            onclick="reply('<?php echo $offer->link_id; ?>')">
                                        <?php echo JText::_('MOD_EMUNDUS_CIFRE_OFFERS_REPLY'); ?>
                                    </button>
                                    <button type="button" class="btn btn-primary"
                                            onclick="breakUp('ignore', '<?php echo $offer->link_id; ?>')">
                                        <?php echo JText::_('MOD_EMUNDUS_CIFRE_OFFERS_IGNORE'); ?>
                                    </button>
                                <?php elseif ($offer->state == '2') : ?>
                                    <button type="button" class="btn btn-primary"
                                            onclick="breakUp('breakup', '<?php echo $offer->link_id; ?>')">
                        ...
                        <div class="em-bottom-space">
                            <div class="em-contact-request-contact">
                                <div class="em-contact-request-heading">
                                    ...
                                    <span class="em-contact-request-name"><strong><?php echo JFactory::getUser($offer->user_to)->name; ?></strong></span>  <span
                                            class="em-contact-request-profile"><strong>(<?php echo $offer->profile; ?>)</strong></span>
                                    <?php echo JText::_('MOD_EMUNDUS_CIFRE_OFFERS_OFFER_NAME'); ?>
                                    <span class="em-contact-request-offer">
                                        <strong>
                                        <?php if (!empty($offer->titre)) : ?>
                            ...
                            <div id="em-buttons-<?php echo $offer->link_id; ?>">
                                <?php if ($offer->state == '1') : ?>
                                    <button type="button" class="btn btn-primary"
                                            onclick="retry('<?php echo $offer->link_id; ?>')">
                                        <?php echo JText::_('MOD_EMUNDUS_CIFRE_OFFERS_RETRY'); ?>
                                    </button>
                                    <button type="button" class="btn btn-primary"
                                            onclick="breakUp('cancel', '<?php echo $offer->link_id; ?>')">
