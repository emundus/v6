...
<center>
	...
	<div class="btnConsulter"><i class="search icon"></i><a href="<?php echo JURI::base();?>index.php?option=com_fabrik&task=list.view&listid=<?php echo $listId; ?>&Itemid=0<?php echo $urlFiltre; ?>" target="_blank"><?php echo JText::_('VIEW_DATA')?></a></div>
</center>
