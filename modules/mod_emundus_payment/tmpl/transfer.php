...
<?php if (strpos(Uri::getInstance(), 'payment_method') !== false) { ?>
    <a href="<?= str_replace('&payment_method=transfer' , '', Uri::getInstance()) ?>" class="flex items-center text-neutral-900 w-fit-content">
...
<section class="rounded bg-white p-4 mt-4" style="min-height: 200px;">
    ...
    <div class="panier">
        <div class="mt-4">
            ...
            <p class="mt-4 em-red-500-color">* <?= Text::_('MOD_EMUNDUS_PAYMENT_PLEASE_REPORT_REFERENCE') ?></p>
        </div>
        <div id="upload-proof-file" class="em-mt-16 em-mb-16">
            <label class="font-bold" for="proof-file"> <?= Text::_('MOD_EMUNDUS_PAYMENT_UPLOAD_PROOF_FILE') ?></label>
            <input
