        ...
        <div class="span12" style="margin:0px;width: 100%;">
            <form id="payer-infos" class="fabrikForm">
                <fieldset class="fabrikGroup">
                    ...
                    <div class="row-fluid">
                        <label for="sender_first_name"><?= JText::_('FLYWIRE_SENDER_FIRST_NAME') ?><b
                    ...
                    <div class="row-fluid">
                        <label for="sender_last_name"><?= JText::_('FLYWIRE_SENDER_LAST_NAME') ?><b
                                    class="asterisk">*</b></label>
                    ...
                    <div class="row-fluid">
                        <label for="sender_email"><?= JText::_('FLYWIRE_SENDER_EMAIL') ?><b
                                    class="asterisk">*</b></label>
                    ...
                    <div class="row-fluid">
                        ...
                        <label for="sender_country"><?= JText::_('FLYWIRE_SENDER_COUNTRY') ?><b
                                    class="asterisk">*</b></label>
                    ...
                    <div class="em-w-100 em-flex-row-end em-justify-content-end em-mt-16">
                        ...
                        <button id="modify-payer-infos"
                                class="hidden em-front-btn em-front-secondary-btn em-w-33 em-ml-8">
