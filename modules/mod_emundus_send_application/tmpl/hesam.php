...
<div class="em-send-print-button">
	...
	<?php if ((!empty($attachments) && (int)($attachments) >= 100 && !empty($forms) && (int)($forms) >= 100 && $application->status==0 && !$is_dead_line_passed) || in_array($user->id, $applicants)) :?>
    ...
    <?php elseif (modemundusSendApplicationHelper::getSearchEngineId($user->fnum)) :?>
        <div class="col-md-12 em-print-button">
