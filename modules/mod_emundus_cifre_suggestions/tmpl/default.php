        ...
        <div class="w-col w-col-6">
            <div>
                <div class="card-offre" id="<?= $offer->fnum; ?>">
                    ...
                    <div class="div-block">
                        <img src="https://assets.website-files.com/5e9eea59278d0a02df79f6bd/5e9f6bfa9fb16576de7aa78d_5e9ef4871565a65129befc4c_Twiice2-%20Plan%20de%20travail%201.svg"
                             alt="" class="image">
                        <div class="name">
							<?= $offer->search; ?>
                        </div>
                ...
                <a href="<?= JRoute::_(JURI::base() . "consultez-les-offres/details/299/" . $offer->search_engine_page); ?>"
                   class="cta-offre w-inline-block">
