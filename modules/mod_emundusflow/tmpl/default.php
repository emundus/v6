  ...
  <div class="<?= ($option=="com_hikashop")?"active":""; ?> <?= $step_paiement; ?> step">
    ...
    <div class="content">
      ...
      <div class="description">
        ...
        <?php echo  ($paid == false && !empty($sentOrder)==0 && $forms>=100 && $attachments>=100 && !$orderCancelled && !isset($scholarship) && !$is_dead_line_passed)?'<a href="'.$checkout_url.'" title="'.JText::_('ORDER_NOW').'">'.JText::_('ORDER_NOW').'</a>':''; ?>
