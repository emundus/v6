            ...
            <div class="<?php echo ($option=="com_hikashop")?"active":""; ?> <?php echo $step_paiement; ?> step">
                ...
                <div class="content">
                    ...
                    <div class="description">
                        ...
                        <?php echo  ($paid==0 && !empty($sentOrder)==0 && $forms>=100 && $attachments>=100 && !$orderCancelled && !$is_dead_line_passed)?'<a href="'.$checkout_url.'" class="order-now" title="'.JText::_('ORDER_NOW').'">'.JText::_('ORDER_NOW').'</a>':''; ?>
