				...
				<div class="single-campaign">
					...
					<div class="below-content">
						...
						<?php if ($currentCampaign->apply_online == 1) :?>
                                <a class="btn btn-primary btn-creux"  role="button" href="javascript:history.back()"><?= JText::_('GO_BACK');?></a>
							<?php
						...
						<?php else :?>
                            <?php if ($mod_em_campaign_get_link) :?>
                                <a class="btn btn-primary btn-creux" role="button" href="javascript:history.back()" data-toggle="sc-modal" ><?= JText::_('GO_BACK');?></a>
                            <?php else :?>
