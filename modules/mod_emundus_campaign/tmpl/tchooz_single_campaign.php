    ...
    <div>
        ...
        <div class="em-flex-row em-mt-16">
            ...
            <div class="em-flex-row em-mr-24">
                <p class="em-text-neutral-600 em-flex-row"><span class="material-icons em-mr-8">alarm</span> <?php echo JText::_('MOD_EM_CAMPAIGN_CAMPAIGN_START_DATE'); ?></p>
            ...
            <div class="em-flex-row">
                <p class="em-text-neutral-600 em-flex-row"><span class="material-icons em-mr-8">schedule</span> <?php echo JText::_('MOD_EM_CAMPAIGN_CAMPAIGN_END_DATE'); ?></p>
            ...
            <div class="em-flex-row">
                <p class="em-text-neutral-600 em-flex-row"><span class="material-icons em-mr-8">alarm</span> <?php echo JText::_('MOD_EM_CAMPAIGN_FORMATION_START_DATE'); ?>:</p>
            ...
            <div class="em-flex-row em-ml-24">
                <p class="em-text-neutral-600 em-flex-row"><span class="material-icons em-mr-8">schedule</span> <?php echo JText::_('MOD_EM_CAMPAIGN_FORMATION_END_DATE'); ?>:</p>
