...
<div class="mod_emundus_campaign__grid em-mt-24 em-mb-64" style="grid-gap: 64px">
    <div>
        <button type="button" class="em-flex-row em-mb-12 em-pointer em-w-max-content"
             ...
             <?php endif; ?>
        >
            <span class="material-icons em-text-neutral-600" aria-hidden="true">navigate_before</span><span class="em-ml-8 em-text-neutral-900"><?php echo JText::_('MOD_EM_CAMPAIGN_BACK'); ?></span>
        </button>
        ...
        <div class="em-grid-small em-mt-8 em-mt-8">
            ...
            <div class="em-flex-row" style="white-space: nowrap;">
                <p class="em-text-neutral-600 em-flex-row em-applicant-default-font "><span class="material-icons em-mr-8" aria-hidden="true">alarm</span> <?php echo JText::_('MOD_EM_CAMPAIGN_CAMPAIGN_START_DATE'); ?></p>
            ...
            <div class="em-flex-row" style="white-space: nowrap;">
                <p class="em-text-neutral-600 em-flex-row em-applicant-default-font "><span class="material-icons em-mr-8" aria-hidden="true">schedule</span> <?php echo JText::_('MOD_EM_CAMPAIGN_CAMPAIGN_END_DATE'); ?></p>
            ...
            <div class="em-flex-row" style="white-space: nowrap;">
                <p class="em-text-neutral-600 em-flex-row em-applicant-default-font"><span class="material-icons em-mr-8" aria-hidden="true">alarm</span> <?php echo JText::_('MOD_EM_CAMPAIGN_FORMATION_START_DATE'); ?>:</p>
            ...
            <div class="em-flex-row" style="white-space: nowrap;">
                <p class="em-applicant-text-color em-flex-row"><span class="material-icons em-mr-8" aria-hidden="true">schedule</span> <?php echo JText::_('MOD_EM_CAMPAIGN_FORMATION_END_DATE'); ?>:</p>
            ...
            <div class="em-flex-row" style="white-space: nowrap;">
                <p class="em-text-neutral-600 em-flex-row"><span class="material-icons em-mr-8" aria-hidden="true">alarm</span> <?php echo JText::_('MOD_EM_CAMPAIGN_ADMISSION_START_DATE'); ?>:</p>
            ...
            <div class="em-flex-row" style="white-space: nowrap;">
                <p class="em-text-neutral-600 em-flex-row"><span class="material-icons em-mr-8" aria-hidden="true">schedule</span> <?php echo JText::_('MOD_EM_CAMPAIGN_ADMISSION_END_DATE'); ?>:</p>
        ...
        <?php if (!empty($mod_em_campaign_show_timezone)) : ?>
            <div class="em-mt-4 em-text-neutral-600 em-flex-row em-camp-time-zone">
                <p class="em-flex-row"><span class="material-icons-outlined em-mr-8" aria-hidden="true">public</span></p>
            ...
            <div class="em-mt-24">
                <?php foreach($files as $file) : ?>
                    <div class="em-flex-row em-mb-16 mod_emundus_campaign__details_file">
                        <span class="material-icons-outlined mod_emundus_campaign__details_file_icon" aria-hidden="true">insert_drive_file</span>
