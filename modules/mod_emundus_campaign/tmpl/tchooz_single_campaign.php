...
<div class="mod_emundus_campaign__grid em-mt-24 em-mb-64" style="grid-gap: 64px">
    <div>
        ...
        <?php endif; ?>
        <h3 class="em-h3 mod_emundus_campaign__campaign_title em-mt-16" style="max-height: unset"><?php echo $currentCampaign->label; ?></h3>
    ...
    <div>
        ...
        <div class="mod_emundus_campaign__details_content em-border-neutral-300 em-mb-24">
            <h6 class="em-h6"><?php echo JText::_('MOD_EM_CAMPAIGN_DETAILS_APPLY') ?></h6>
        ...
        <div class="mod_emundus_campaign__details_content em-border-neutral-300 em-mb-24">
            <h6 class="em-h6"><?php echo JText::_('MOD_EM_CAMPAIGN_DETAILS_DOWNLOADS') ?></h6>
            <div class="em-mt-24">
        ...
        <div class="mod_emundus_campaign__details_content em-border-neutral-300">
            <h6 class="em-h6"><?php echo JText::_('MOD_EM_CAMPAIGN_DETAILS_CONTACT') ?></h6>
        </div>
        <?php endif; ?>
    </div>
</div>
