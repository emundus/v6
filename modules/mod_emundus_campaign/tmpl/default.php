                    ...
                    <div class="campaign-month-campaigns"><!-- rt12 toclose -->
                        ...
                        <div class="campaign-content">
                            ...
                            <?php if ($result->apply_online == 1) :?>
                                <a class="btn btn-primary em-btn em-btn-secondary" role="button" href='<?php echo ("index.php?option=com_emundus&view=programme&id=".$result->id."&Itemid=".$mod_em_campaign_itemid); ?>' data-toggle="sc-modal"><?php echo JText::_('MORE_INFO'); ?></a>
                                <?php
                        ...
                        <div class="campaign-content">
                            ...
                            <?php if ($result->apply_online == 1) :?>
                                ...
                                <?php if (date('Y/m/d H:i', strtotime($result->start_date)) <= date('Y/m/d H:i') && date('Y/m/d H:i', strtotime($result->end_date)) >= date('Y/m/d H:i')) {?>
                                    <a class="btn btn-primary em-btn em-btn-primary" role="button" href='<?php echo ("index.php?option=com_users&view=registration&course=".$result->code."&cid=".$result->id."&Itemid=".$mod_em_campaign_itemid);?>' data-toggle="sc-modal"><?php echo JText::_('APPLY_NOW'); ?></a>
                                <?php } ?>
                            <?php else :?>
                                <a class="btn btn-primary em-btn em-btn-secondary" role="button" href='<?php echo ("index.php?option=com_emundus&view=programme&id=".$result->id."&Itemid=".$mod_em_campaign_itemid2); ?>' data-toggle="sc-modal"><?php echo JText::_('MORE_INFO'); ?></a>
                            <?php endif; ?>
