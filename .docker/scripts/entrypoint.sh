...
echo >&2 "========================================================================"
echo >&2
echo >&2 "We preparing your Tchooz installation. Please wait..."
echo >&2
echo >&2 "========================================================================"
...
if [[ "$1" == apache2* ]] || [ "$1" == php-fpm ]; then
        ...
        if [ ! -e templates/g5_helium/templateDetails.xml ]; then
          ...
          cp -r /config templates/g5_helium/custom/config
        fi
        ...
        echo >&2 "========================================================================"
        echo >&2
        echo >&2 "This server is now configured to run Tchooz product"
        echo >&2
        echo >&2 "========================================================================"
fi
