                    ...
                    success: function(result) {
                        if (result.status) {
                            ...
                            $('#data').append( '<div id="methode" style="display: none" class="em-grid-2 em-mt-16">'+
                                ...
                                '<input type="radio" name="em-export-methode" id="em-export-methode" value="0"' + (methode_to_check == 0 ? ' checked'  : '') +'>' +Joomla.JText._('COM_EMUNDUS_CHOOSE_EXTRACTION_METHODE_AGGREGATE_DISTINCT')+
                                '<br/><input type="radio" name="em-export-methode" id="em-export-methode" value="2"' + (methode_to_check == 2 ? ' checked'  : '') +'>' +Joomla.JText._('COM_EMUNDUS_CHOOSE_EXTRACTION_METHODE_AGGREGATE')+
                                '<br/><input type="radio" name="em-export-methode" id="em-export-methode" value="1"' + (methode_to_check == 1 ? ' checked'  : '') +'>' +Joomla.JText._('COM_EMUNDUS_CHOOSE_EXTRACTION_METHODE_LEFTJOIN')+ '<br>'+
                                '</form></div></div></div>'+
