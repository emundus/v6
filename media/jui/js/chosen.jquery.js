...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.default_multiple_text = Joomla.JText._('COM_EMUNDUS_PLEASE_SELECT_MULTIPLE');

    AbstractChosen.default_single_text = Joomla.JText._('COM_EMUNDUS_PLEASE_SELECT');
