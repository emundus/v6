...
dojo.addOnLoad(function(){
  var params = {
    ...
    returnUrl: '/index.php?option=com_content&view=featured&Itemid=1079',
    border: 'f5f5f5|*|3|*|c4c4c4|*|7'.split('|*|')[1].split('||')[0],
    padding: '4|*|0d5f95|*|3'.split('|*|')[0].split('||')[0],
    useAJAX: 0,
    openEvent: 'onclick',
    wndCenter: 0,
    dur: 250,
    ...
    userLng: 'User Name',
    passLng: 'Password',
    base: 'http://emundus.local/',
    theme: 'elegant',
    socialProfile: 0? '/index.php?option=com_users&amp;view=profile&amp;layout=edit' : '',
    socialType: 'socialIco',
    cssPath: '/modules/mod_improved_ajax_login/cache/106-langen-GB/7217174eae3c9ba88febfaeab188b949.css',
    regPage: 'joomla',
    captcha: '',
    showHint: 0,
