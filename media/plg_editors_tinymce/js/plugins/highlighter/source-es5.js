(function () {
  ...
  var cmPath = rootPath + "/media/vendor/codemirror"; // CodeMirror settings
  ...
  var isMac = /macintosh|mac os/i.test(navigator.userAgent); // Utility function to load CodeMirror script files
  ...
  var start = function start() {
    ...
    CMsettings.config.value = html; // Instantiate CodeMirror:
  ...
  CMsettings = Object.assign({}, CMsettings, userSettings); // Append the stylesheets
