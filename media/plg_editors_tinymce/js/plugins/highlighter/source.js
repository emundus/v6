...
const cmPath = `${rootPath}/media/vendor/codemirror`; // CodeMirror settings
...
const isMac = /macintosh|mac os/i.test(navigator.userAgent); // Utility function to load CodeMirror script files
