(function () {
  ...
  (function (Joomla, document) {
    ...
    var setUp = function setUp(e) {
      ...
      var publicKey = JSON.parse(atob(rawPKData)); // Convert the public key information to a format usable by the browser's credentials manager
      ...
      navigator.credentials.create({
        ...
        document.getElementById('com-users-method-code').value = btoa(JSON.stringify(publicKeyCredential)); // Submit the form
