(function () {
      ...
      new Promise(function (resolve, reject) {
        Joomla.request({
          ...
          onSuccess: function onSuccess(resp) {
            ...
            document.getElementById('search-reset').innerHTML = Joomla.sanitizeHtml(Joomla.Text._('JSEARCH_FILTER_CLEAR')); // eslint-disable-next-line no-shadow
  ...
  customElements.whenDefined('joomla-tab').then(function () {
    ...
    var link = installerTabs.querySelector('button[aria-controls=web]'); // Abort if the IFW tab cannot be found
