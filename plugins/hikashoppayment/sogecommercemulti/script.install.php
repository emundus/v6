...
class plghikashoppaymentsogecommercemultiInstallerScript
{
    /**
    ...
    function postflight($route, $adapter)
    {
        ...
        JFile::move('sogecommercemulti_j3.xml', 'sogecommercemulti.xml', $path);
    }
    ...
    function preflight($type, $adapter)
    {
        if ($type === 'uninstall') {
            ...
            if (JFile::exists($targetFolder . DS . 'sogecommercemulti_cards.png')) {
                JFile::delete($targetFolder . DS . 'sogecommercemulti_cards.png');
            }

            if (JFile::exists($targetFolder . DS . 'sogecommercemulti.png')) {
                JFile::delete($targetFolder . DS . 'sogecommercemulti.png');
            }
        }
    }
}
