...
class plghikashoppaymentsystempaymultiInstallerScript
{
    /**
    ...
    function postflight($route, $adapter)
    {
        ...
        JFile::move('systempaymulti_j3.xml', 'systempaymulti.xml', $path);
    }
    ...
    function preflight($type, $adapter)
    {
        if ($type === 'uninstall') {
            ...
            if (JFile::exists($targetFolder . DS . 'systempaymulti_cards.png')) {
                JFile::delete($targetFolder . DS . 'systempaymulti_cards.png');
            }

            if (JFile::exists($targetFolder . DS . 'systempaymulti.png')) {
                JFile::delete($targetFolder . DS . 'systempaymulti.png');
            }
        }
    }
}
