...
//        echo "\nTags array............................................................\n";  print_r( $this->xmltags );
  ...
  */
  function DoRequest( $url = null, $auth = CURLAUTH_BASIC ) {
    $headers = array();
    ...
    curl_setopt($c, CURLOPT_URL, $this->protocol . '://' . $this->server . $url);
    ...
    curl_setopt($c, CURLOPT_CUSTOMREQUEST, $this->requestMethod);
    ...
    //echo $this->protocol . '://' . $this->server . $url.PHP_EOL;
    //echo $this->httpRequest.PHP_EOL.$this->xmlRequest.PHP_EOL.PHP_EOL;
    //echo $this->httpResponseBody.PHP_EOL.PHP_EOL;die;

    $this->headers = array();  // reset the headers array for our next request
    $this->ParseResponse($this->httpResponseBody);
    return $this->httpResponseHeaders . PHP_EOL . $this->httpResponseBody;
  }
...
EOFILTER;
  ...
  */
  function GetEntryByHref( $href ) {
    $href = str_replace( array(rawurlencode('/'), rawurlencode(':')), array('/', ':'), rawurlencode($href));
