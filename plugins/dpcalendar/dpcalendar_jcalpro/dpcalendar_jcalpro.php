...
JModelLegacy::addIncludePath(JPATH_PLUGINS . '/dpcalendar/dpcalendar_jcalpro/models', 'DPCalendarJCalProModel');

class PlgDPCalendarDPCalendar_JCalPro extends DPCalendarPlugin
{
