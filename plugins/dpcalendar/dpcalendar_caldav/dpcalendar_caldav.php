...
JLoader::import('dpcalendar.dpcalendar_caldav.libraries.caldav.caldav-client', JPATH_PLUGINS);

class PlgDPCalendarDPCalendar_CalDAV extends DPCalendarPluginCalDAV
{
