 ...
 * @description Génère le paramétrage de la relance email en fonction de la date d'envoie du dossier :: par ex. : alerte pour un envoie de rapport au bout d'un an
 */
