...
require_once (JPATH_SITE.DS.'components'.DS.'com_emundus'.DS.'models'.DS.'candidatelistforcandidate.php');
...
$cancelInterview = $jinput->getValue('jos_dpcalendar_events___Confirmation');
...
try
{
	...
	$confirm = new EmundusModelCandidatelistforcandidate;
    if($cancelInterview == '1'){
	$confirm->cancelInterview($calId,$cancelInterview); 
	die("<div class='col-md-12'><center><h1>Interview canceled.</h1></center></div>");
} else if($cancelInterview == '0'){
    die("<div class='col-md-12'><center><h1>This interview is not cancel.</h1></center></div>");
}
