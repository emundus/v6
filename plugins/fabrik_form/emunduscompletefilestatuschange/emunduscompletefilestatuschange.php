...
class PlgFabrik_FormEmunduscompletefilestatuschange extends plgFabrik_Form {
	...
	public function onBeforeCalculations() {
		...
		$attachments = $m_application->getAttachmentsProgress($fnumInfos['applicant_id'], $fnumInfos['profile_id'], $fnum);
		$forms = $m_application->getFormsProgress($fnumInfos['applicant_id'], $fnumInfos['profile_id'], $fnum);
