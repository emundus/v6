<?php
/**
 * Emundus_areacodephonefield Element
 *
 * @package     Joomla.Plugin
 * @subpackage  Fabrik.element.Emundus_areacodephonefield
 ...
 * @since       3.0
 */
class PlgFabrik_ElementEmundus_areacodephonefield extends PlgFabrik_ElementList
{
    /**
     * connection
     *
    ...
    public function render($data, $repeatCounter = 0)
    {
        ...
        JHTML::script('plugins/fabrik_element/emundus_areacodephonefield/emundus_areacodephonefield.js');
        $params        = $this->getParams();
    ...
    protected function renderDropdownList($data, $repeatCounter, &$html, $tmp, $defaultValue)
    {
        ...
        if (FabrikWorker::j3())
        {
            ...
            /*var_dump( (object)($layout->render($displayData)));
            die();*/
           // dd($html);
            //return $layout->render($displayData);
     ...
     *
     * @param   PlgFabrik_ElementEmundus_areacodephonefield $elementModel element model
