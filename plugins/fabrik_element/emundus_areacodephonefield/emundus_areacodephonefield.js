...
var FbDatabasejoin = {
    ...
    initialize: function (element, options) {
        ...
        this.setPlugin('emundus_areacodephonefield');
    ...
    watchOnLoad: function () {


        /* var num =Fabrik.getBlock('form_307').formElements.get('jos_emundus_users___tel').getContainer();

        /*this.getContainer().parentNode.append(num);
        this.getContainer().style.width = '100px';
        this.getContainer().parentNode.style.display = 'flex';
        this.getContainer().parentNode.setAttribute('style', 'flex-direction: row');*/
        console.log('fabrick ')
        console.log(this);


        jQuery('#jos_emundus_1008_00___phone_area').chosen();
    ...
    watchOnChange:function (){

        console.log('on changes events watching');
        return 'yes yes';

    },

    /*watchOnChanges: function () {

        console.log(document.getElementsByTagName('form')[1].id)
        //console.log(document.querySelector('form#'+elementId.split('___')[0]+'___fnum').value;
        // var num =Fabrik.getBlock('form_307').formElements.get('jos_emundus_users___tel').getContainer();
    ...
    updateFromServer: function (v) {
        ...
        new Request.JSON({
            ...
            onSuccess: function (json) {
                ...
                // we dont want tjoin_val_columno update its value
