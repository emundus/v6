...
<select name="<?php echo $d->name . '[year]'; ?>" class="col-sm-4 fabrik_filter" <?php echo $data; ?> >
...
<select name="<?php echo $d->name . '[month]'; ?>" class="col-sm-4 fabrik_filter" <?php echo $data; ?> >
...
<select name="<?php echo $d->name . '[day]'; ?>" class="col-sm-4 fabrik_filter" <?php echo $data; ?> >
