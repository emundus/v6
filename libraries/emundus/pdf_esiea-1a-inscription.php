/** @noinspection HtmlDeprecatedAttribute */<?php


// GET COUNTRY
function getCountry($country) {
	$db = JFactory::getDBO();
	$db->setQuery('SELECT valeur FROM jos_emundus_sise_code_pays WHERE code = '.(int)$country);
...
function application_form_pdf($user_id, $fnum = null, $output = true, $form_post = 1, $form_ids = null, $options = null, $application_form_order = null, $profile_id = null, $file_lbl = null) {
	...
	try {
		...
		$country = [
			$db->qn('country.name_fr', 'country_ea')
		];

		$nationality = [
			$db->qn('nationality.value', 'nationality_ea')
		];

		$query
			->select(array_merge($emundus_user, $personal_details, $academy, $admission, $cursus_repeat, $cities, $country, $nationality, $declaration))
			...
			->leftjoin($db->qn('#__emundus_country', 'country') . ' ON ' . $db->qn('ea.country_1') . ' = ' . $db->qn('country.id'))
			->leftjoin($db->qn('#__emundus_nationality', 'nationality') . ' ON ' . $db->qn('ea.nationality') . ' = ' . $db->qn('nationality.id'))
			->where($db->qn('cc.fnum') . ' LIKE ' . $db->q($fnum));

		$db->setQuery($query);
		$item = $db->loadAssoc();
	} catch (Exception $e) {
		var_dump($db->getErrorMsg()).die();
		JLog::add('SQL error in emundus pdf library at query : '.$query, JLog::ERROR, 'com_emundus');
	}
   ...
   ';
	...
	$page1 .='	
   <table cellpadding="6">
      <tr><th width="20"></th><th width="600" ><b>Ce dossier et à remplir et à retourner par mail ou voie postale à :</b></th></tr>
	</table>
					...
					<tr>
						<td class="blue-border" width="340" height="300">
							<table cellpadding="4">
								...
								<tr>
									<td class="fnt-size-25"><p><b>Adresse : </b>' . $item['street_1'] .' '. $item['street_2'] . ' ' . $item['street_3'] .'</p></td>
								</tr>
								<tr>
								...
								<tr>
									<td class="fnt-size-25"><p><b>Pays : </b>' . $item['country_ea'] . '</p></td>
								</tr>	
								<tr>
								<td></td>
								</tr>
								...
								<tr>
									<td class="fnt-size-25 "><b>Ville de naissance :</b></td>
								</tr>
								<tr>
								<td></td>
								</tr>
								<tr>
									<td class="fnt-size-25"><p><b>Nationalité : </b>' . $item['nationality_ea'] . '</p></td>
								</tr>
							</table>
						</td>
					</tr>
					...
					<tr>
						...
						<table cellpadding="4">
							...
							<tr>
								...
								<td width="200">
									<b>Signature : </b>
									<div style="visibility: hidden;">signature_1</div>
								</td>
							</tr>
		...
		<td class="blue-border" width="700" height="80">
				<table cellpadding="3">
					...
					<tr>
						<td width="10"></td>
						<td width="680">
							<p>Si oui, précisez les nom, prénom, année de promotion : ' . strtoupper($item["link_school_parent_alu_nom"]) . ' ' . $item["link_school_parent_alu_prenom"] . ' / ANNEE ' . $item["link_school_parent_alu_annee_promotion"] . '</p>
						</td>
					</tr>
				</table>
		</td>
		...
		<td class="blue-border" width="700" height="112">
				<table cellpadding="3">
					...
					<tr>
						...
						<td width="350" class="fnt-size-25 ">Fait à : ................................................................................... le : .....................................</td>
					</tr>	
					<tr>
						<td class="header-sepeator" width="8"></td>
						<td width="340" class="fnt-size-25 "><p>E-mail : ' . $item["repondant_financier_email"] .'</p></td>
						<td width="125" class="fnt-size-25 "><b>Signature du répondant financier :</b><div style="visibility: hidden;">signature_2</div></td>
					</tr>	
				</table>
		</td>
		</tr>
	...
	<table>
		...
		<td class="blue-border" width="700" height="950">
			...
			<tr>
				<td width="10"></td>
				<td width="250"><p class="fnt-size-35"><b>Lien de parenté avec l’étudiant(e) : </b></p></td>
			</tr>
			<tr>
				<td width="10"></td>
				<td width="680"><p class="fnt-size-35"><b>Adresse pendant l’année scolaire : </b>' . $item["responsable_adresse_1"].'</p></td>
			</tr>
			<tr>
				<td width="10"></td>
			...
			<tr>
				<td width="10"></td>
				<td width="250"><p class="fnt-size-35"><b>E-mail : </b>' . $item["responsable_email_1"].'</p></td>
			</tr>
			<tr>
				<td width="10"></td>
				<td width="250"><p class="fnt-size-35"><b>Nom de l’entreprise : </b></p></td>
			</tr>
			<tr>
				<td width="10"></td>
				<td width="650"><p class="fnt-size-35"><b>Profession (choisir, dans la liste ci-dessous, les deux chiffres de la codification INSEE correspondante) : </b>' . $item["responsable_profession_1"].'</p></td>
			</tr>
			...
			<tr>
					...
					<tr>
						<td width="10"></td>
						<td width="680"><p class="fnt-size-35"><b>Adresse pendant l’année scolaire : </b>' . $item["responsable_adresse_2"].'</p></td>
					</tr>
					<tr>
						<td width="10"></td>
					...
					<tr>
						<td width="10"></td>
						<td width="250"><p class="fnt-size-35"><b>E-mail : </b>' . $item["responsable_email_2"].'</p></td>
					</tr>
					<tr>
						<td width="10"></td>
						<td width="250"><p class="fnt-size-35"><b>Nom de l’entreprise : </b></p></td>
	...
	<tr>
		...
		<td class="blue-border" width="700" height="575">
			<table cellpadding="5">
				...
				<tr>
					<td width="10"></td>
					<td width="400"><b class="fnt-size-35">Type du baccalauréat <span class="blue-text">></span> choisir le code dans la liste ci-dessous :</b></td>
				</tr>
				<tr>
					<td width="10"></td>
				...
				<tr>
					<td width="10"></td>
					<td width="600"><b class="fnt-size-35">Académie d’obtention du baccalauréat <span class="blue-text">></span> choisir le code dans la liste ci-dessous :</b></td>
				</tr>
				...
				<tr>
					<td width="10"></td>
					<td width="680"><p class="fnt-size-35"><b>Cursus suivi </b>(exemple : BTS, DUT, CPGE, LICENCE...) : </p></td>
				</tr>
				...
				<tr>
					<td width="10"></td>
					<td width="680"><p class="fnt-size-35"><b>Nom et adresse de l’établissement fréquenté : </b>'.getinstitut($item["previous_establishment_repeat"]). ' ' . $item["institut_adresse_repeat"] .'</p></td>
				</tr>
...
// BUILD 5TH PAGE
	...
	$page5 .= '
				<table cellpadding="5">
					...
					<tr>
						<td width="330" class="fnt-size-32"><p><b>Signature obligatoire</b><br>de l\'étudiant(e)</p><div style="visibility: hidden;">signature_1</div></td>
						<td width="330" class="fnt-size-32"><p><b>Signature obligatoire</b><br>du répondant financier</p><div style="visibility: hidden;">signature_2</div></td>
					</tr>
				</table>
';
		...
		$page7 .= '
				...
				<table cellpadding="5">
					...
					<tr>
						...
						<td width="330">
							<div style="visibility: hidden;">signature_2</div>
						</td>
					</tr>
